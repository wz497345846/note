...
<form id="query-employee" onsubmit="return false;" action="/selectEmployee">
    ...
    <div>
        ...
        <select class="easyui-combobox" id="empstate" name="empstate" style="width:200px;" panelHeight="auto"
                editable="false">
        ...
        <label for="roleid">职位:</label>
        <select class="easyui-combobox" id="roleid" name="roleid" style="width:200px;" panelHeight="auto"
